...
void eulerThree() {
    ...
    for (int i = 2; product >
                    1; i++) {         //erhöht i in jedem Durchlauf um die Primefaktoren zu finden, solange der Quotient nicht eins ist
        while (product % i ==
               0) {              //Schleife sorgt dafür dass die For-Schleife dass der aktuelle Primefaktor i mehrfach genutzt wird
...
void eulerSix() {
    unsigned long int powOfSum, sumOfSquares;
